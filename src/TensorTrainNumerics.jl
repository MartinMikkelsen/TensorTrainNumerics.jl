...
export toeplitz_to_qtto, qtto_prolongation, qtto_constant_prolongation, qtto_linear_prolongation, ∇, Δ_DN, Δ_ND, Δ_NN, Δ_P, Δ, Δ⁻¹_DN, shift, circulant_qtto, qtt_cconv, qtt_conv, zeros_tt, zeros_tto, rand_tt, id_tto, rand_tto, qtt_laplacian
